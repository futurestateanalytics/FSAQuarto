...
1.  **Foundational Analytics Package**:
    ...
    -   Pricing: Starting at $800 per project, with additional fees based on data volume and complexity.
...
2.  **Data Visualization and Storytelling**:
    ...
    -   Pricing: Starting at $1,000 for dashboard development, $1,2000 for deep-dive analyses
